...
<display:table cellpadding="2" cellspacing="20" id="employee" name="employee" pagesize="10"
	...
	<display:column property="emp_id" title="Employee Id No." sortable="false" />
	<display:column property="name" title="Employee Name"
		href="editEmployeeData.htm" paramId="id" paramProperty="emp_id"
		sortable="false" />
	<display:column property="address" title="Address" sortable="false" />
	<display:column property="salary" title="Salary" sortable="false" />
	<display:column value="Delete" href="deleteEmployeeData.htm" paramId="id"
		paramProperty="emp_id" title="Delete" sortable="false" />
