...
<h2>Welcome To The Inventory Search Page</h2>
<center>
<h2>Inventory Search Form</h2>
<form:form id="search" name="search" action="searchinventory.htm"
	...
	<table>
		...
		<tr>
			...
			<td><form:input path="quantityStored" /></td>
		</tr>
		<tr>
